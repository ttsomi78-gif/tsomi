  ...
  return (
    <div>
      ...
      <p className="mb-4 mt-0.5 text-sm text-gray-500">
        ...
        from the country they choose and listed on the delivery policy page.
        Only the countries named below can be ordered to — anywhere else, the
        checkout asks the customer to message you on Instagram.
      </p>
