...
const dictionary: Dictionary = {
  ...
  order: {
    ...
    paidText: "Thank you for your order! We'll call you shortly to arrange the delivery.",
    failedHeading: "Payment failed",
    failedText: "You have not been charged. Please try again.",
    pendingHeading: "Payment processing",
    pendingText: "Waiting for the bank to confirm — this page refreshes itself in a moment.",
    expiredHeading: "Payment time ran out",
    expiredText: "The payment wasn't completed and you haven't been charged. Feel free to try again.",
