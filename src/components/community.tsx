...
export function Community({ dict }: { dict: Dictionary }) {
  return (
    <section className="mx-auto max-w-330 px-4 pb-20 sm:px-6">
      <div className="relative overflow-hidden rounded-4xl bg-gradient-to-br from-terracotta to-brick px-6 py-14 text-center text-cream shadow-xl shadow-brick/20 sm:px-12 sm:py-16">
        ...
        <div className="relative">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-8 inline-flex items-center gap-3 rounded-full bg-cream px-8 py-4 font-bold uppercase tracking-wide text-ink shadow-lg shadow-ink/20 transition-all duration-300 hover:-translate-y-0.5 hover:bg-yolk"
          >
