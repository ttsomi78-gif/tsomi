...
export const pageMeta: Record<string, Record<LocaleId, PageMeta>> = {
  ...
  shipping: {
    en: {
      ...
      description:
        "Delivery across Georgia in 2–5 business days, plus shipping to the EU and USA. 14-day returns on unworn items. Simple rules, no small print.",
    },
    ka: {
      title: "მიწოდება და დაბრუნება",
      description:
        "მიწოდება მთელ საქართველოში 2–5 სამუშაო დღეში, ასევე ევროკავშირსა და აშშ-ში. 14-დღიანი დაბრუნება უტარებელ ნივთებზე. მარტივი წესები.",
    },
    ru: {
      title: "Доставка и возврат",
      description:
        "Доставка по всей Грузии за 2–5 рабочих дней, а также в страны ЕС и США. Возврат в течение 14 дней для неношеных вещей. Простые правила.",
    },
    ja: {
      title: "配送と返品",
      description:
        "ジョージア全土へ2〜5営業日でお届け。EU・アメリカへの海外配送にも対応。未着用品は14日以内返品可能。シンプルなルール。",
    },
  },
  terms: {
    en: {
